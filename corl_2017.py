...
class CoRL2017(ExperimentSuite):
    ...
    def build_experiments(self):
        ...
        camera_central_rgb = Camera('CentralRGB')
        camera_central_rgb.set(FOV=100)
        camera_central_rgb.set_image_size(200, 150)
        camera_central_rgb.set_position(2.0, 0.0, 1.4)
        camera_central_rgb.set_rotation(-15.0, 0, 0)

        camera_central_seg = Camera('CentralSemanticSeg', PostProcessing='SemanticSegmentation')
        camera_central_seg.set_image_size(200, 150)
        camera_central_seg.set(FOV=100)
        camera_central_seg.set_position(2.0, 0.0, 1.4)
        camera_central_seg.set_rotation(-15.0, 0, 0)

        camera_top_rgb = Camera('TopRGB')
        camera_top_rgb.set_image_size(200, 150)
        camera_top_rgb.set(FOV=100)
        camera_top_rgb.set_position(12.0, 0.0, 15.0)
        camera_top_rgb.set_rotation(-90.0, 90.0, -90.0)

        camera_top_seg = Camera('TopSemanticSeg', PostProcessing='SemanticSegmentation')
        camera_top_seg.set_image_size(200, 150)
